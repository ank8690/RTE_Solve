...
Face::Face()
{
	...
	m_d_vec_face_ray_Inten.clear();
	/*if(m_d_vec_vec_face_ray_Inten.size())
	{
		for(int i = 0; i < m_d_vec_vec_face_ray_Inten.size(); ++i)
		{
			m_d_vec_vec_face_ray_Inten[i].clear();
		}
		m_d_vec_vec_face_ray_Inten.clear();
	}*/
}
